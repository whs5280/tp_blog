...
class User extends AdminBase {
    ...
    public function index($keyword = '', $page = 1) {
        ...
        $user_list = $this->user_model->where($map)->order('id DESC')->paginate($this->getConfig("admin_page"), false, ['page' => $page]);
