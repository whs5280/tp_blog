<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:25:"themes\article\index.html";i:1482377637;s:26:"themes\\header\header.html";i:1482413546;s:24:"themes\\right\right.html";i:1482719769;s:26:"themes\\footer\footer.html";i:1482388149;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
	<head>		
	<title><?php echo $article['title']; ?>-<?php echo $site_config['site_title']; ?></title>
	<meta name="keywords" content="<?php echo $article['keywords']; ?>"/>
	<meta name="description" content="<?php echo $article['introduction']; ?>"/>
			...
			<div class="line-big">
				<div class="xl12 xm8">
					<div class="line-small">
						<div class="xs12">
							<div class="a_title"><?php echo $article['title']; ?></div>
							<div class="a-write">时间：&nbsp;<?php echo $article['publish_time']; ?>&nbsp;&nbsp;作者：<a><?php echo $article['author']; ?></a>&nbsp;&nbsp;阅读：（<?php echo $article['reading']; ?>）</div>
				      ...
				      <?php echo htmlspecialchars_decode($article['content']) ?>
							...
							<div class="a-write hidden-xs">
								本文为原创，转载请注明出处:&nbsp;&nbsp;<a><?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?></a>
									<br>								发表自：&nbsp;<?php echo $getcategoryName[$article['cid']]; ?>&nbsp;&nbsp;地址：<?php echo $article['position']; ?>&nbsp;&nbsp;关键词：&nbsp;<?php echo $article['keywords']; ?>&nbsp;&nbsp;
							</div>
							<br />
						...
						<hr />
						<div class="a-up">
							<p>上一篇：<?php echo !empty($prevs['title'])?'<a href="'.url('article/index','id='.$prevs['id']).'">'.$prevs['title'].'</a>' : '没有了'; ?></p>
						</div>
						<div class="a-down">
							<p>下一篇：<?php echo !empty($nexts['title'])?'<a href="'.url('article/index','id='.$nexts['id']).'">'.$nexts['title'].'</a>' : '没有了'; ?></p>
						</div>
