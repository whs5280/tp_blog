<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:29:"admin_themes\links\index.html";i:1481966866;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/links/add'); ?>">添加链接</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" action="<?php echo url('admin/links/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($links_list) || $links_list instanceof \think\Collection): if( count($links_list)==0 ) : echo "" ;else: foreach($links_list as $key=>$vo): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/links/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe642;</i> 编辑</a>
                            <a href="<?php echo url('admin/links/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
