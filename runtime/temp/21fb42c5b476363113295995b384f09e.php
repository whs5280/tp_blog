<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"admin_themes\admin_user\index.html";i:1482060912;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($admin_user_list) || $admin_user_list instanceof \think\Collection): if( count($admin_user_list)==0 ) : echo "" ;else: foreach($admin_user_list as $key=>$vo): ?>
                    <tr>
                        <td><?php echo $vo['id']; ?></td>
						  <td>
						<?php if(strtoupper($vo['headimgurl']) != ''): ?><img src="<?php echo $vo['headimgurl']; ?>" style="width:35px; height:35px; border-radius:50px;"/>
<?php else: ?><img src="__img__/default_thumb.png" style="width:35px; height:35px; border-radius:50px;"/>
<?php endif; ?>
						</td>
                        ...
                        <td>
                            <a href="<?php echo url('admin/admin_user/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe642;</i> 编辑</a>
                            <a href="<?php echo url('admin/admin_user/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
