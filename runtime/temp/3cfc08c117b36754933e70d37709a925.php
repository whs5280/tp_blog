<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:27:"admin_themes\nav\index.html";i:1481967298;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/nav/add',['pid'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini"><i class="layui-icon">&#xe61f;</i> 添加子导航</a>
                            <a href="<?php echo url('admin/nav/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe642;</i> 编辑</a>
                            <a href="<?php echo url('admin/nav/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
