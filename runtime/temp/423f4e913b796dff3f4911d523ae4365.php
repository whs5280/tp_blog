<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"admin_themes\guestbook\index.html";i:1481967105;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            ...
            <form class="layui-form layui-form-pane" action="<?php echo url('admin/guestbook/index'); ?>" method="get">
            ...
            <form action="" method="post" class="ajax-form">
                <button type="button" class="layui-btn layui-btn-small ajax-action" data-action="<?php echo url('admin/guestbook/toggle',['type'=>'audit']); ?>"><i class="layui-icon">&#xe643;</i> 审核</button>
                <button type="button" class="layui-btn layui-btn-warm layui-btn-small ajax-action" data-action="<?php echo url('admin/guestbook/toggle',['type'=>'cancel_audit']); ?>"><i class="layui-icon">&#xe63f;</i> 取消审核</button>
                <button type="button" class="layui-btn layui-btn-danger layui-btn-small ajax-action" data-action="<?php echo url('admin/guestbook/delete'); ?>"><i class="layui-icon">&#xe640;</i> 删除</button>
                <div class="layui-tab-item layui-show">
                    <table class="layui-table">
                        ...
                        <tbody>
                        <?php if(is_array($guestbook_list) || $guestbook_list instanceof \think\Collection): if( count($guestbook_list)==0 ) : echo "" ;else: foreach($guestbook_list as $key=>$vo): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('admin/guestbook/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe611;</i> 回复</a>
                                <a href="<?php echo url('admin/guestbook/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
                    ...
                    <!--分页-->
                    <?php echo $guestbook_list->render(); ?>
                </div>
            </form>
        </div>
    </div>
