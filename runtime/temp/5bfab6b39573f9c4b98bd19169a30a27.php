<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:26:"themes\category\index.html";i:1482396432;s:26:"themes\\header\header.html";i:1482413546;s:24:"themes\\right\right.html";i:1482719769;s:26:"themes\\footer\footer.html";i:1482388149;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh-cn">
<head>		
	<title><?php echo $getcategory['name']; ?>-<?php echo $site_config['site_title']; ?></title>
	<meta name="keywords" content="<?php echo $getcategory['name']; ?>"/>
	<meta name="description" content="<?php echo $getcategory['content']; ?>"/>
		...
		<div class="container">
			<div class="">
				<ul class="bread">
					...
					<li><a href="#"><?php echo $getcategory['name']; ?></a></li>
					</h4>
				</ul>
			</div>
			<div class="line-big">
				<div class="xl12 xm8">
					<div class="line-small">
						<div class="xs12">
						 ...
						 <?php if(is_array($article_list) || $article_list instanceof \think\Collection): if( count($article_list)==0 ) : echo "暂时没有数据<br />" ;else: foreach($article_list as $key=>$vo): ?>
							<div class="clearfix articlebox">
									<div class="detail_a">
									    
									<?php echo $vo['tag']==1 ? '<span class="tag bg-dot">原创</span>' : '<span class="tag bg-green">转载</span>'; ?>&nbsp;&nbsp;
									<a href="<?php echo url('article/index','id='.$vo['id']); ?>" style="font-size: 16px;"><?php echo $vo['title']; ?></a>
	                                <?php echo $vo['is_good']==1 ? '<div class="a_tuijian"><img src="__public__images/tuijian.gif" style="width:70px" /></div>' : ''; ?>
									</div>
									<div class="article">

										<ul class="icourse-course">
											 <li>
									                <a href="<?php echo url('article/index','id='.$vo['id']); ?>">
											            <div class="icourse-img">

																<?php if(strtoupper($vo['thumb']) != ''): ?><img src="<?php echo $vo['thumb']; ?>" onerror="this.src='__public__images/default_thumb.png'" class="img" title="" width="100%" height="200px" />
<?php else: ?><img src="__public__images/default_thumb.png" width="100%" height="200px"/>
<?php endif; ?>
										...
										<div class="remark">
										<?php echo $vo['introduction']; ?>					</div>
									</div>
	
									<div class="write">
										<span class="icon-paper-plane"></span>&nbsp;<?php echo $vo['publish_time']; ?> &nbsp;&nbsp;作者：<?php echo $vo['author']; ?> &nbsp;&nbsp;分类：[&nbsp;<?php echo $getcategoryName[$vo['cid']]; ?>&nbsp;]<span class="hidden-xs">&nbsp;&nbsp;点击：[&nbsp;<?php echo $vo['reading']; ?>&nbsp;]</span>
									</div>
									<div class="look-all">
										<a href="<?php echo url('article/index','id='.$vo['id']); ?>" class="button border-blue" role="button">查看全部</a>
									</div>
								</div>
								<br />
						...
						<div class="pages" style=" text-align: right;">
							 <?php echo $article_list->render(); ?>						</div>
					</div>
					<br />
					<br />
					<br />
