<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"admin_themes\advertising\index.html";i:1482401943;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/advertising/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($advertising_list) || $advertising_list instanceof \think\Collection): if( count($advertising_list)==0 ) : echo "" ;else: foreach($advertising_list as $key=>$vo): ?>
                    <tr>
                        <td><?php echo $vo['id']; ?></td>
						<td><?php echo $vo['sort']; ?></td>
                        <td><?php echo $vo['adname']; ?></td>
                        <td><?php echo $vo['adurl']; ?></td>
                        <td><img src="<?php echo $vo['adpic']; ?>" style="width:100px; height:30px;"/></td>
                        <td><?php echo $vo['status']==1 ? '启用' : '禁用'; ?></td>
                        <td><?php echo $vo['create_time']; ?></td>
                      
                        <td>
                            <a href="<?php echo url('admin/advertising/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe642;</i> 编辑</a>
                            <a href="<?php echo url('admin/advertising/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                ...
                <!--分页-->
                <?php echo $advertising_list->render(); ?>
            </div>
        </div>
    </div>
</div>
