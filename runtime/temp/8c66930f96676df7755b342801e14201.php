	...
	<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="container">
			...
			<div class="line-big">
				<div class="xl12 xm8">
					<div class="line-small">
						<div class="xs12">
						<?php if(is_array($toparticle) || $toparticle instanceof \think\Collection): if( count($toparticle)==0 ) : echo "" ;else: foreach($toparticle as $key=>$vo): ?>
			<div class="clearfix articlebox">
	                                ...
	                                <?php echo $vo['is_top']==1 ? '<div class="a_tuijian"><img src="__public__images/top.gif" style="width:70px" /></div>' : ''; ?>
									</div>
									<div class="article">
