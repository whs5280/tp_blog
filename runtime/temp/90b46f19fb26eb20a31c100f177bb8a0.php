<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"admin_themes\system\site_config.html";i:1481966446;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/system/updateSiteConfig'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="site_config[admin_page]" value="<?php echo $site_config['admin_page']; ?>" placeholder="请输入每页显示多少" autocomplete="off" class="layui-input">
                        </div>
                    </div>
