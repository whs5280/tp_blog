<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:27:"admin_themes\links\add.html";i:1481787508;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/links/index'); ?>">友情链接管理</a></li>
            <li class="layui-this">添加链接</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/links/save'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">链接名称</label>
                        <div class="layui-input-block">
                            <input type="text" name="linkname" value="" required lay-verify="required" placeholder="请输入链接名称" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="linkurl" value="" placeholder="请输入链接地址 http://" class="layui-input">
                        </div>
                    </div>
