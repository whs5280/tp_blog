<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"admin_themes\admin_user\add.html";i:1481796996;s:22:"admin_themes\base.html";i:1482388352;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-header header">
       <div class="logo"><i class="layui-icon" style="font-size:40px;">&#xe62e;</i>  <?php echo $site_config['site_title']; ?></div>
        <div class="user-action">
            <a href="javascript:;"><i class="layui-icon">&#xe612;</i> <?php echo session('user_nickname'); ?></a>
