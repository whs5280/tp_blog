<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:28:"admin_themes\tell\index.html";i:1481967205;s:22:"admin_themes\base.html";i:1482389208;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/tell/add'); ?>">发布说说</a></li>
        </ul>
        <div class="layui-tab-content">

            <form class="layui-form layui-form-pane" action="<?php echo url('admin/tell/index'); ?>" method="get">
            ...
            <form action="" method="post" class="ajax-form">
                <button type="button" class="layui-btn layui-btn-small ajax-action" data-action="<?php echo url('admin/tell/toggle',['type'=>'audit']); ?>"><i class="layui-icon">&#xe643;</i> 审核</button>
                <button type="button" class="layui-btn layui-btn-warm layui-btn-small ajax-action" data-action="<?php echo url('admin/tell/toggle',['type'=>'cancel_audit']); ?>"><i class="layui-icon">&#xe63f;</i> 取消审核</button>
                <button type="button" class="layui-btn layui-btn-danger layui-btn-small ajax-action" data-action="<?php echo url('admin/tell/delete'); ?>"><i class="layui-icon">&#xe640;</i> 删除</button>
                <div class="layui-tab-item layui-show">
                    <table class="layui-table">
                        ...
                        <tbody>
                        <?php if(is_array($tell_list) || $tell_list instanceof \think\Collection): if( count($tell_list)==0 ) : echo "" ;else: foreach($tell_list as $key=>$vo): ?>
                        <tr>
                            <td><input type="checkbox" name="ids[]" value="<?php echo $vo['id']; ?>"></td>
                            <td><?php echo $vo['id']; ?></td>
                            <td><?php echo htmlspecialchars_decode($vo['tellcontent']) ?></td>
                            <td><?php echo $author[$vo['tellid']]; ?></td>
                            <td><?php echo $vo['status']==1 ? '已审核' : '未审核'; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td>
                                <a href="<?php echo url('admin/tell/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini"><i class="layui-icon">&#xe642;</i> 编辑</a>
                                <a href="<?php echo url('admin/tell/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete"><i class="layui-icon">&#xe640;</i> 删除</a>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
