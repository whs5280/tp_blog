<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:20:"themes\gb\index.html";i:1482386114;s:26:"themes\\header\header.html";i:1482413546;s:24:"themes\\right\right.html";i:1482719769;s:26:"themes\\footer\footer.html";i:1482388149;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh-cn">
	<head>		
	<title>留言-<?php echo $site_config['site_title']; ?></title>
...
<?php endif; ?>
										...
										<div class="liuyan_t">
											<span class="icon-user"></span>&nbsp;&nbsp;<a><?php echo $vo['nickname']; ?></a>&nbsp;&nbsp;</span>
											<span class="icon-paper-plane"></span>&nbsp;<?php echo $vo['create_time']; ?>&nbsp;&nbsp;</span>
											<span class="tag bg-dot"><?php echo $vo['os']; ?></span>&nbsp;&nbsp;<span class="icon-map-marker"></span>&nbsp;<?php echo $vo['position']; ?>										</div>
										<div class="liuyan_c">
										<?php echo htmlspecialchars_decode($vo['content']) ?>	</div>
										...
										<form action="/index.php/index/gb/add" name="signupForm" id="signupForm" method="post" class="form form-block">						
											<div class="form-group">
												<div class="field">
													...
													<input type="text" class="input" id="username" name="username" value="<?php echo session('user_nickname'); ?>" readonly="readonly" placeholder="请输入昵称" />
												</div>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="field">
													...
													<img style="margin-top: -33px;margin-left: 50%;display: block;border: 1px solid #C7C7C7;" class="img" src="<?php echo captcha_src(); ?>" onClick="this.src = this.src + '?' + Math.random();" title="看不清楚?点击刷新验证码?">
												</div></div>
											</div>
